...
const nav = [
  { to: HOME_LINK, label: 'Замовлення', icon: ClipboardList },
  { to: CLIENTS_LINK, label: 'Клієнти', icon: Users },
  { to: PRODUCTS_LINK, label: 'Товари', icon: Package2 },
  { to: NEW_ORDERS_LINK, label: 'Нове замовлення', icon: ShoppingCart },
]
</script>
