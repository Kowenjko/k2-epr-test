...
Revision ID: 54238adeb18c
Revises:
Create Date: 2026-05-10 10:34:49.381768
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["client_id"], ["clients.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Ціна на момент замовлення",
        ),
        sa.ForeignKeyConstraint(
